...
module Attachmentable
  ...
  MAX_MATRIX_LIMIT = (ENV['ATTACHMENTABLE_MAX_MATRIX_LIMIT'] || 33_177_600).to_i # 7680x4320px or approx. 847MB in RAM
  GIF_MATRIX_LIMIT = (ENV['ATTACHMENTABLE_GIF_MATRIX_LIMIT'] || 921_600).to_i    # 1280x720px
